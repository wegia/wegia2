...
<li class="breadcrumb-item active" aria-current="page">
    <a class="link-secondary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover" href="{{route('pessoaMain')}}">
...
<div class="content-body">
        ...
        <div class="card-body bg-dark">
            <form method="GET" action="{{route('atendidos.validarCpf')}}">
                <div class="form-outline form-white">
                    <input type="text" id="inputCheckCPF" name="cpf" class="form-control" inputmode="numeric" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" maxlength="14" placeholder="Ex. 222.222.222-22">
                </div>
    ...
    <div class="col-lg-10 col-md-8 mx-auto m-5">
        <div class="alert alert-danger alert-dismissable fade show rounded-end" style="border-left:#721C24 10px solid; border-radius: 0px">
            <div class="container">
    ...
    <div class="row m-5" id="formulario">
        <ul class="nav nav-pills nav-fill pb-2">
            <li class="nav-item">
                <button class="nav-link bg-dark" id="cadastroAtendido" data-bs-toggle="tab" data-bs-target="#cadastroAtendido" type="button" role="tab" aria-controls="cadastroAtendido" aria-selected="true">Cadastro de Atendidos
                </button>
            </li>
        </ul>
        <div class="tab-content bg-dark text-white rounded p-3">
            <div class="tab-pane fade show active" id="cadastroAtendido" role="tabpanel" aria-labelledby="cadastroAtendido" tabindex="0">
                <form method="POST" action="/pessoa/atendidos">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="generoF" name="genero" value="f" required>
                                <label class="form-check-label" for="generoF">
                                    <i class="fa fa-female" style="font-size: 20px;"></i>
                                </label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" id="generoN" name="genero" value="" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" id="telefone" name="telefone" maxlength="11" minlength="10" inputmode="numeric" pattern="^\(?\d{2}\)?\s?\d{4,5}-?\d{4}$" placeholder="Ex: (22)99999-9999" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <input type="date" class="form-control" id="nascimento" name="nascimento" maxlength="10" placeholder="dd/mm/aaaa" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" id="cpf" value="{{$cpf}}" maxlength="14" disabled>
                        </div>
                    </div>
    ...
    -->
        ...
        <div class="modal fade" id="novoStatusModal" tabindex="-1" aria-labelledby="novoStatusModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input class="form-control" type="text" maxlength="45" id="iptNovoStatus" name="status.nome">
                    </div>
    ...
    -->
        ...
        <div class="modal fade" id="novoTipoModal" tabindex="-1" aria-labelledby="novoTipoModal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <input class="form-control" type="text" maxlength="45" id="iptNovoTipo" name="tipo.nome">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
