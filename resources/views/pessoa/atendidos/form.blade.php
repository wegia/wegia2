...
@section('content')
        ...
        @else
            @if($cpfJaExiste || !$cpfEvalido)
                <div class="alert alert-danger" role="alert">
                    <h2>Erro. Funcionário já cadastrado no sistema.</h2>
                </div>
                <div class="card col-lg-10 col-md-8 mx-auto m-5 text-bg-dark">
                    <h5 class="card-header">Digite seu CPF</h5>
                    <div class="card-body">
    ...
    <div class="modal fade" id="novoStatusModal" tabindex="-1"
         aria-labelledby="novoStatusModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="addStatus" type="submit" class="btn btn-primary"
                            data-bs-dismiss="modal">Cadastrar
                    </button>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="novoTipoModal" tabindex="-1"
         aria-labelledby="novoTipoModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-footer">
                    ...
                    <button id="addTipo" type="submit" class="btn btn-primary" data-bs-dismiss="modal">Cadastrar
                    </button>
                </div>
            </div>
        </div>
